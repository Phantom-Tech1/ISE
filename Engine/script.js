...
function searchable() {
    ...
    } else if (searchBar.value == "hammerhead3") {
    ...
    } else if (searchBar.value == "hammerhead4") {
        location.href = "https://byvolp.firebaseapp.com/"
    } else if (searchBar.value == "hammerhead5") {
        location.href = "https://ssoportal.gq/"
    } else if (searchBar.value == "hammerhead6") {
        location.href = "https://educationgg-23704.web.app/"
    } else if (searchBar.value == "hammerhead7") {
